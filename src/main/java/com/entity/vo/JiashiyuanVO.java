...
public class JiashiyuanVO  implements Serializable {
	...
	public void setJiazhenghaoma(String jiazhenghaoma) {
		this.jiazhenghaoma = jiazhenghaoma;
	}
	
	/**
	 * 获取：驾证号码
	 */
	public String getJiazhenghaoma() {
		return jiazhenghaoma;
	}

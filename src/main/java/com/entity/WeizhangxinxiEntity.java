...
public class WeizhangxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：违章处罚
	 */
	public void setWeizhangchufa(String weizhangchufa) {
		this.weizhangchufa = weizhangchufa;
	}
	/**
	 * 获取：违章处罚
	 */
	public String getWeizhangchufa() {
		return weizhangchufa;
	}
